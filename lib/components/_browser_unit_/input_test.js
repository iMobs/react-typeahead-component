...
describe('Input', function () {
    describe('#componentDidUpdate', function () {
        ...
        it('should remove the `dir` attribute if re-rendered with a null/undefined value', function (done) {
            ...
            var inputInstance = ReactDOM.render(React.createElement(Input, { dir: 'rtl' }), div);
            var node = ReactDOM.findDOMNode(inputInstance);

            var values = [null, undefined];
            values.forEach(function (value, i) {
                ReactDOM.render(React.createElement(Input, { dir: value }), div, function () {
        ...
        it('should not remove the `dir` attribute if re-rendered with a legit value', function (done) {
            ...
            ReactDOM.render(React.createElement(Input, { dir: 'ltr' }), div, function () {
    ...
    describe('#handleChange', function () {
        it('should call `onChange` if the input value did change', function () {
            var handleChange = sinon.spy(),
                inputInstance = TestUtils.renderIntoDocument(React.createElement(Input, {
                value: 'ezequiel',
        ...
        it('should not throw an error if `onChange` was not passed in', function () {
            var inputInstance = TestUtils.renderIntoDocument(React.createElement(Input, {
                value: 'ezequiel'
            }));
    ...
    describe('#isCursorAtEnd', function () {
        ...
        it('should return `true` if the cursor is at the end', function () {
            var value = 'ezequiel',
                inputInstance = ReactDOM.render(React.createElement(Input, {
                value: value
            }), this.iframeDiv),
        ...
        it('should return `false` if the cursor is at the beginning', function () {
            var inputInstance = ReactDOM.render(React.createElement(Input, {
                value: 'ezequiel'
            }), this.iframeDiv),
                inputDOMNode = ReactDOM.findDOMNode(inputInstance);
        ...
        it('should return `true` if there is no `value`', function () {
            var inputInstance = ReactDOM.render(React.createElement(Input, null), this.iframeDiv);
